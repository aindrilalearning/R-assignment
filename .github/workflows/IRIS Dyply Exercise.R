...
# Exercise 9
# Compute the average number of Sepal.Length, apply the mean() function to the column Sepal.Length,
#and call the summary value "avg_slength". HINT: Use summarize().
